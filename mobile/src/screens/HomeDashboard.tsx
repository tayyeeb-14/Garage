...
const baseStyles = StyleSheet.create({
  ...
  userName: { ...typography.userName, marginTop: spacing.xs, marginBottom: spacing.xs },
  ...
  locationLabel: { ...typography.caption, color: colors.textLight },
  locationValue: { color: colors.textMuted, fontWeight: '600', fontSize: 13, marginTop: 2 },
